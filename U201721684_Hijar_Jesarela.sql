...
/* creamos la funcion */
alter FUNCTION masinscripcionesdeunasede(@csede INT, @fecha_inicio DATETIME, @fecha_final DATETIME)

/* me retornara una tabla */
RETURNS TABLE
AS
...
from Persona p join Empleado e on p.CPersona=e.CEmpleado
join Inscripcion i on e.CEmpleado=i.CEmpleado
join Usuario u on i.CUsuario=u.CUsuario where
e.CEmpleado=@cempleado ) 



SELECT * FROM inscripcionesrealizadas(40025622) 
