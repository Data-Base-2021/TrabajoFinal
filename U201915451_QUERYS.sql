...
select * from DescuentoCompra('2019/06/01','2020/06/01',600)
...
from Venta v join VentaPresencial vp on v.CVenta = vp.CVentaPresencial
...
from Venta v join VentaVirtual vv on v.CVenta = vv.CVentaVirtual
...
select * from MarcaProd('2018/01/01','2019/12/31')
